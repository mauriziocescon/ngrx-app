...
@NgModule({
  ...
  providers: [
    reducerProvider,
    ...SERVICES,
    {provide: BlockListService, useClass: B1BlockListService},
    {provide: BlockHooksService, useClass: B1BlockHooksService},
    {provide: BlockUtilsService, useClass: B1BlockUtilsService},
  ],
})
