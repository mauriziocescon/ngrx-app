          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="button-row">
                <button class="btn btn-primary action-button" (click)="moveToNextStep()" [disabled]="!nextStepBtnEnabled">{{ "COMPONENT.NEXT_STEP.NEXT_STEP" | translate }}</button>
              </div>
              <div class="button-row">
                <button class="btn btn-default action-button" (click)="resetForm()">{{ "COMPONENT.NEXT_STEP.CANCEL" | translate }}</button>
              </div>
