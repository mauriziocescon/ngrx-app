...
describe('BlockListContainerComponent', () => {
  let component: BlockListContainerComponent;
  let fixture: ComponentFixture<BlockListContainerComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BlockListContainerComponent);
